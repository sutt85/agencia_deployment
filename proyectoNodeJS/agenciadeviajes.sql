...
INSERT INTO `testimoniales` VALUES (1,'Victor Bonet','victor@bonet.com','Unas vacaciones increíbles!!'),(2,'Pablo','pablo@pablito.com','It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.mensaje'),(3,'Klaudia','klaudia@pepe.com','There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat'),(4,'Pepito','de@lospalotes.com','kekekekeke suuuuu'),(5,'carlos','carlos@correo.com','Prueba de async await');
...
-- Dump completed on 2019-12-11 19:34:05
